...
var francais = {
  ...
  noliBusan: "L'expérience à Busan — un séjour d'étude sur place (avril 2026), au plus près du terrain : repérages, rencontres, entretiens et tournage auprès de joueurs de tous âges, dans les parcs, les cafés de jeux et les PC bang de la ville.",
  noliRoleTitre: "Mon rôle",
  noliRole: "<li><strong>Développement web</strong> — la partie interactive du site : le parcours animé à travers les lieux et les fiches de jeux.</li><li><strong>Recherche historique</strong> — documentation sur l'histoire des jeux coréens, rédaction du contexte et construction de la frise chronologique.</li><li><strong>Multilinguisme & traduction</strong> — traduction des grilles d'entretien (français ↔ coréen) et préparation des questions posées sur place.</li><li><strong>Sous-titrage</strong> — des séquences tournées en coréen.</li><li><strong>Communication</strong> — échanges et coordination avec les partenaires et intervenants coréens.</li>",
...
var anglais = {
  ...
  noliBusan: "The Busan experience — a study trip on the ground (April 2026): scouting, meetings, interviews, and filming with players of all ages, in the city's parks, board-game cafés, and PC bangs.",
  noliRoleTitre: "My role",
  noliRole: "<li><strong>Web development</strong> — the site's interactive part: the animated journey through the locations and the game cards.</li><li><strong>Historical research</strong> — research on the history of Korean games, writing the historical context, and building the timeline.</li><li><strong>Multilingualism & translation</strong> — translating the interview guides (French ↔ Korean) and preparing the on-site questions.</li><li><strong>Subtitling</strong> — of the footage filmed in Korean.</li><li><strong>Communication</strong> — exchanges and coordination with the Korean partners and contributors.</li>",
